...
for i in Op:
    ...
    TR['NRC']=OpData[Pym.loc[i].NRCs]
    TR['NDC']=OpData[Pym.loc[i].NDCs]
    TR['QNDCs']=OpData[Pym.loc[i].CPAQualifiedNDCs]
    TR['Deposits']=OpData[Pym.loc[i].Deposits]
    TR['Net Revenue']=OpData[Pym.loc[i].NetRevenue]
    TR['Total Commission Operator']=OpData[Pym.loc[i].Commission]
